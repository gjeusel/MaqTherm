...
if("$ENV{PE_ENV}" STREQUAL GNU)
  ...
  set(CMAKE_Fortran_FLAGS_DEBWITHGPROF "${CMAKE_Fortran_FLAGS_DEBUG} -pg -g" CACHE STRING "")
  set(CMAKE_Fortran_FLAGS_RELWITHGPROF "${CMAKE_Fortran_FLAGS_RELEASE} -pg -g" CACHE STRING "")
